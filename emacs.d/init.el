...
(use-package org
  ...
  (setq org-capture-templates
    `(("t" "Tasks / Projects")
      ...
      ("m" "Metrics Capture")
      ("mw" "Weight" table-line (file+headline "~/soure/OrgFiles/Metrics.org" "Weight")
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(visual-fill-column org-bullets magit counsel-projectile projectile hydra evil-collection spaceline evil xterm-color eterm-256color doom-themes which-key use-package rainbow-delimiters powerline ivy dracula-theme diminish command-log-mode)))
(custom-set-faces
